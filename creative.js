/* prebid-universal-creative v1.8.0
Updated : 2020-06-04 */
!(function (r) {
    var n = {};
    function o(t) {
    ...
    function (t, e, r) {
        ...
        Object.defineProperty(e, "__esModule", { value: !0 }),
            ...
            (e.insertElement = function (t, e, r) {
                ...
                try {
                    (n = n.length ? n : e.getElementsByTagName("body")).length && (n = n[0]).insertBefore(t, n.firstChild);
                } catch (t) {}
            });
    },
    function (t, e, r) {
    ...
    function (t, e, r) {
            ...
            (e.newRenderingManager = function (h, d) {
                function n(t, e, r, n, o, i) {
                    var a = 2 < arguments.length && void 0 !== r ? r : "",
                        ...
                        c = 4 < arguments.length ? o : void 0,
                        u = 5 < arguments.length ? i : void 0,
                        l = "Prebid_";
                    if (a.substr(0, l.length) === l)
                        ...
                        var p = ""
                            .concat(
                                (function (t, e) {
                                    var r = void 0 === e || "" === e ? b : e;
                                    return "https://".concat(void 0 === t || "" === t ? v : t).concat(r);
                                })(t, e),
                                "?uuid="
                            )
                            .concat(a);
                            ...
                            !(function (n, o) {
                                if (d.isSafeFrame()) {
                                    var i = h.innerWidth,
                                        a = h.innerHeight;
                                    (i === n && a === o) ||
                                        (h.$sf.ext.register(n, o, function (t) {
                                            var e = n - i,
                                                r = o - a;
                                            h.$sf.ext.expand({ r: e, b: r, push: !0 });
                                        }),
                                        h.parent.postMessage({ sentinel: "amp", type: "embed-size", width: n, height: o }, "*"));
                                }
                            })(f[0], f[1]);
                        } else console.log("Targeting key hb_size not found to resize creative");
                        g.sendRequest(p, y(u, c));
                    }
                }
                function y(s, c) {
                    return function (t) {
                        var e = (function (t) {
                                ...
                                try {
                                    ...
                                    console.log("Error parsing response from cache host: ".concat(t));
                                }
                                return e;
                            })(t),
                            r = g.getCreativeCommentMarkup(e),
                            n = e.width ? e.width : e.w,
                            o = e.height ? e.height : e.h;
                        if ((e.wurl && (0, g.triggerPixel)(decodeURIComponent(e.wurl)), e.adm))
                            (e.adm = c ? e.adm.replace("${AUCTION_PRICE}", c) : e.adm.replace("${AUCTION_PRICE}", "")),
                                (r += s ? u(e.adm, n, o) : e.adm),
                                e.nurl && (r += g.createTrackPixelHtml(decodeURIComponent(e.nurl))),
                                g.writeAdHtml(r);
                        else if (e.nurl)
                            if (s) {
                                (r += u(g.loadScript(h, e.nurl).outerHTML, n, o)), g.writeAdHtml(r);
                            } else {
                                var i = e.nurl,
                                    a = g.getCreativeComment(e);
                                m.insertElement(a, document, "body"), g.writeAdUrl(i, n, o);
                            }
                        e.burl && g.triggerBurl(e.burl);
                    };
                }
                function u(t, e, r) {
                    var n = g.getUUID();
                    return '<div id="'
                        .concat(n, '" style="border-style: none; position: absolute; width:100%; height:100%;">\n      <div id="')
                        .concat(n, '_inner" style="margin: 0 auto; width:')
                        .concat(e, "; height:")
                        .concat(r, '; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">')
                        .concat(t, "</div>\n      </div>");
                }
                return {
                    renderAd: function (t, e) {
                        ...
                        d.isMobileApp(r.env)
                            ...
                            : d.isAmp(r.uuid)
                            ? n(r.cacheHost, r.cachePath, r.uuid, r.size, r.hbPb)
                            : d.canLocatePrebid()
                            ? (function (t, e) {
                            ...
                            : (function (p, t, e) {
                                  var r,
                                      ...
                                      o = 2 < arguments.length ? e : void 0,
                                      i = h.location,
                                      a = g.parseUrl(o),
                                      f = a.protocol + "://" + a.host,
                                      s = n || h.location.hostname,
                                      c = i.protocol + "//" + s;
                                  function u(t) {
                                      ...
                                      if (r.message && "Prebid Response" === r.message && f === n && r.adId === p && (r.ad || r.adUrl)) {
                                          var o = h.document.body,
                                              i = r.ad,
                                              a = r.adUrl,
                                              s = r.width,
                                              c = r.height;
                                          if ("video" === r.mediaType) console.log("Error trying to write ad.");
                                              ...
                                              var u = m.getEmptyIframe(r.height, r.width);
                                              o.appendChild(u), u.contentDocument.open(), u.contentDocument.write(i), u.contentDocument.close();
                                          } else if (a) {
                                              var l = m.getEmptyIframe(c, s);
                                              (l.style.display = "inline"), (l.style.overflow = "hidden"), (l.src = a), m.insertElement(l, document, "body");
                                          } else console.log("Error trying to write ad. No ad for bid response id: ".concat(id));
                                      }
                                  }
                                  h.addEventListener("message", u, !1), (r = JSON.stringify({ message: "Prebid Request", adId: p, adServerDomain: c })), h.parent.postMessage(r, f);
                              })(r.adId, r.adServerDomain, r.pubUrl);
                    },
                };
            });
        var g = n(r(3)),
        ...
        var v =  "prebid-cache.bydata.com", //"prebid.adnxs.com",
            b =  "/cache"; //"/pbc/v1/cache";
    },
    function (t, n, e) {
        "use strict";
        Object.defineProperty(n, "__esModule", { value: !0 }),
            (n.triggerPixel = function (t, e) {
                var r = new Image();
                e && "function" == typeof e && (r.addEventListener("load", e), r.addEventListener("error", e));
                r.src = t;
            }),
            (n.createTrackPixelHtml = function (t) {
                if (!t) return "";
                var e = encodeURI(t);
                    ...
                    r &&
                        ...
                        (o.readyState
                            ? (o.onreadystatechange = function () {
                                  ("loaded" !== o.readyState && "complete" !== o.readyState) || ((o.onreadystatechange = null), r());
                              })
                            : (o.onload = function () {
                                  r();
                              }));
                o.src = e;
                var i = n.getElementsByTagName("head");
                (i = i.length ? i : n.getElementsByTagName("body")).length && (i = i[0]).insertBefore(o, i.firstChild);
                return o;
            }),
            (n.getCreativeComment = function (t) {
                return document.createComment("Creative ".concat(t.crid, " served by Prebid.js Header Bidding"));
            }),
            (n.getCreativeCommentMarkup = function (t) {
                var e = n.getCreativeComment(t),
                    r = document.createElement("div");
                return r.appendChild(e), r.innerHTML;
            }),
            (n.transformAuctionTargetingData = function (e) {
                var r = { hb_adid: "adId", hb_cache_host: "cacheHost", hb_cache_path: "cachePath", hb_cache_id: "uuid", hb_format: "mediaType", hb_env: "env", hb_size: "size", hb_pb: "hbPb" };
                function t(t) {
                    return !(
                        !e[t] ||
                        !(
                    ...
                    ? (o = (function (e) {
                          ...
                          return (
                              Object.keys(e).forEach(function (t) {
                                  Array.isArray(e[t]) && 0 < e[t].length && (r[t] = e[t][0]);
                              }),
                              r
                          );
                      })(e.targetingMap))
                ...
                return (
                    ...
                    Object.keys(e).forEach(function (t) {
                        "targetingMap" !== t && "targetingKeywords" !== t && s(e[t]) && "" !== e[t] && (n[t] = e[t]);
                    }),
                    n
                );
            }),
            (n.parseUrl = function (t) {
                ...
                return (
                    (e.href = decodeURIComponent(t)),
                    {
                        ...
                        hash: (e.hash || "").replace(/^#/, ""),
                        host: (e.host || window.location.host).replace(/:(443|80)$/, ""),
                    }
                );
            });
        var o = (function (t) {
            ...
            return (
                ...
                (r.m = n = [
                    ...
                    function (t, e, r) {
                        ...
                        function h() {
                            ...
                            if (t) {
                                var e = i.last(t);
                                e.afterDequeue(),
                                    (t.stream = function (t, e, n) {
                                        ((f = new c.default(t, n)).id = l++), (f.name = n.name || f.id), (d.streams[f.name] = f);
                                        ...
                                        return (
                                            ...
                                            f.write(e, function () {
                                                s(r, o), (f.win.onerror = a), n.done(), (f = null), h();
                                            }),
                                            f
                                        );
                                    }.apply(void 0, t)),
                        ...
                        function d(t, e, r) {
                            if (i.isFunction(r)) r = { done: r };
                            else if ("clear" === r) return (p = []), (f = null), void (l = 0);
                            r = i.defaults(r, a);
                            var n = [(t = /^#/.test(t) ? window.document.getElementById(t.substr(1)) : t.jquery ? t[0] : t), e, r];
                            return (
                                (t.postscribe = {
                                    cancel: function () {
                                        n.stream ? n.stream.abort() : (n[1] = u);
                                    },
                                }),
                                r.beforeEnqueue(n),
                                p.push(n),
                    ...
                    function (t, e, r) {
                        ...
                        function u(t, e, r) {
                            var n = 2 < arguments.length && void 0 !== r ? r : null,
                                o = l + e;
                            a.existy(n) && "" !== n ? t.setAttribute(o, n) : t.removeAttribute(o);
                        }
                        var h =
                            ...
                            (d.prototype._writeImpl = function (t) {
                                ...
                                for (var e = void 0, r = void 0, n = void 0, o = []; (e = this.parser.readToken()) && !(r = a.isScript(e)) && !(n = a.isStyle(e)); ) (e = this.options.beforeWriteToken(e)) && o.push(e);
                                0 < o.length && this._writeStaticTokens(o), r && this._handleScriptToken(e), n && this._handleStyleToken(e);
                            }),
                                ...
                                for (var e = this.actuals.length, r = [], n = [], o = [], i = t.length, a = 0; a < i; a++) {
                                    ...
                                    if ((r.push(c), s.attrs)) {
                                        if (!/^noscript$/i.test(s.tagName)) {
                                            var u = e++;
                                            n.push(c.replace(/(\/?>)/, " " + l + "id=" + u + " $1")),
                                                s.attrs.id !== f && s.attrs.id !== p && o.push("atomicTag" === s.type ? "" : "<" + s.tagName + " " + l + "proxyof=" + u + (s.unary ? " />" : ">"));
                                        }
                                    } else n.push(c), o.push("endTag" === s.type ? c : "");
                                }
                            ...
                            (d.prototype._walkChunk = function () {
                                for (var t = void 0, e = [this.proxyRoot]; a.existy((t = e.shift())); ) {
                                    var r = 1 === t.nodeType;
                                    if (!r || !c(t, "proxyof")) {
                                        r && u((this.actuals[c(t, "id")] = t), "id");
                                        var n = t.parentNode && c(t.parentNode, "proxyof");
                            ...
                            (d.prototype._writeStyleToken = function (t) {
                                ...
                                this._insertCursor(e, p), t.content && (e.styleSheet && !e.sheet ? (e.styleSheet.cssText = t.content) : e.appendChild(this.doc.createTextNode(t.content)));
                            }),
                            (d.prototype._buildStyle = function (t) {
                                var r = this.doc.createElement(t.tagName);
                                return (
                                    r.setAttribute("type", t.type),
                                    a.eachKey(t.attrs, function (t, e) {
                                        r.setAttribute(t, e);
                                    }),
                                    r
                                );
                            ...
                            (d.prototype._writeScriptToken = function (t, e) {
                                ...
                                try {
                                    this._insertCursor(r, f), (r.src && !n) || e();
                                } catch (t) {
                            ...
                            (d.prototype._buildScript = function (t) {
                                ...
                                return (
                                    ...
                                    t.content && (r.text = t.content),
                                    r
                                );
                            }),
                            (d.prototype._scriptLoadHandler = function (e, r) {
                                function n() {
                        ...
                        function d(t) {
                            ...
                            !(function (t, e) {
                                ...
                                (this.parser = new i.default("", { autoFix: e.autoFix })),
                                (this.actuals = [t]),
                                (this.proxyHistory = ""),
                                ...
                                (r.m = n = [
                                    ...
                                    function (t, e, r) {
                                        ...
                                        var l = { comment: /^<!--/, endTag: /^<\//, atomicTag: /^<\s*(script|style|noscript|iframe|textarea)[\s\/>]/i, startTag: /^</, chars: /^[^<]/ },
                                            p =
                                                ...
                                                (f.prototype.peekToken = function () {
                                                    return this._peekToken();
                                                }),
                                                (f.prototype.readToken = function () {
                                                    return this._readToken();
                                                }),
                                                (f.prototype.readTokens = function (t) {
                                        ...
                                        function f() {
                                            ...
                                            var n = !1,
                                                o = {};
                                            for (var i in a) a.hasOwnProperty(i) && (r.autoFix && (o[i + "Fix"] = !0), (n = n || o[i + "Fix"]));
                                            n
                                                ? ((this._readToken = (0, s.default)(this, o, function () {
                                                      return t._readTokenImpl();
                                                  })),
                                                  (this._peekToken = (0, s.default)(this, o, function () {
                                                      return t._peekTokenImpl();
                                                  })))
                                                : ((this._readToken = this._readTokenImpl), (this._peekToken = this._peekTokenImpl));
                                        }
                                        for (var h in (((e.default = p).tokenToString = function (t) {
                                            return t.toString();
                                        }),
                                        (p.escapeAttributes = function (t) {
                                            var e = {};
                                            for (var r in t) t.hasOwnProperty(r) && (e[r] = (0, c.escapeQuotes)(t[r], null));
                                            return e;
                                        }),
                                        (p.supports = a)))
                                            a.hasOwnProperty(h) && (p.browserHasFlaw = p.browserHasFlaw || (!a[h] && h));
                                    },
                                    function (t, e) {
                                        "use strict";
                                        var r = !(e.__esModule = !0),
                                            n = !1,
                                    ...
                                    function (t, e, r) {
                                        ...
                                        (e.comment = function (t) {
                                            var e = t.indexOf("--\x3e");
                                            if (0 <= e) return new s.CommentToken(t.substr(4, e - 1), e + 3);
                                        }),
                                            (e.chars = function (t) {
                                                var e = t.indexOf("<");
                                                return new s.CharsToken(0 <= e ? e : t.length);
                                            }),
                                            (e.startTag = o),
                                            (e.atomicTag = function (t) {
                                                ...
                                                if (e) {
                                                    ...
                                                    if (r.match(new RegExp("</\\s*" + e.tagName + "\\s*>", "i"))) {
                                                        ...
                                                        if (n) return new s.AtomicTagToken(e.tagName, n[0].length + e.length, e.attrs, e.booleanAttrs, n[1]);
                                                    }
                                                }
                                            }),
                                            (e.endTag = function (t) {
                                                var e = t.match(c.endTag);
                                                if (e) return new s.EndTagToken(e[1], e[0].length);
                                            });
                                        var s = r(4),
                                            c = {
                                        ...
                                        function o(t) {
                                            var r, n, o;
                                            if (-1 !== t.indexOf(">")) {
                                                var e = t.match(c.startTag);
                                                if (e) {
                                                    var i =
                                                        ((r = {}),
                                                        (n = {}),
                                                        (o = e[2]),
                                                        e[2].replace(c.attr, function (t, e) {
                                                            arguments[2] || arguments[3] || arguments[4] || arguments[5]
                                                                ? arguments[5]
                                                                    ? ((r[arguments[5]] = ""), (n[arguments[5]] = !0))
                                                                    : (r[e] = arguments[2] || arguments[3] || arguments[4] || (c.fillAttr.test(e) && e) || "")
                                                                : (r[e] = ""),
                                                                (o = o.replace(t, ""));
                                                        }),
                                                        { v: new s.StartTagToken(e[1], e[0].length, r, n, !!e[3], o.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")) });
                                    ...
                                    function (t, e, r) {
                                        ...
                                        (e.Token = function t(e, r) {
                                            s(this, t), (this.type = e), (this.length = r), (this.text = "");
                                        }),
                                            (e.CommentToken =
                                                ...
                                                n));
                                        function n(t, e) {
                                            s(this, n), (this.type = "comment"), (this.length = e || (t ? t.length : 0)), (this.text = ""), (this.content = t);
                                        }
                                        e.CharsToken =
                                            ...
                                            o);
                                        function o(t) {
                                            s(this, o), (this.type = "chars"), (this.length = t), (this.text = "");
                                        }
                                        var i = (e.TagToken =
                                            ((c.formatTag = function (t, e) {
                                                ...
                                                for (var o in t.attrs)
                                                    if (t.attrs.hasOwnProperty(o)) {
                                                        n += " " + o;
                                                        var i = t.attrs[o];
                                                        (void 0 !== t.booleanAttrs && void 0 !== t.booleanAttrs[o]) || (n += '="' + (0, a.escapeQuotes)(i) + '"');
                                                    }
                                                return t.rest && (n += " " + t.rest), t.unary && !t.html5Unary ? (n += "/>") : (n += ">"), null != r && (n += r + "</" + t.tagName + ">"), n;
                                            }),
                                            c));
                                        function c(t, e, r, n, o) {
                                            s(this, c), (this.type = t), (this.length = r), (this.text = ""), (this.tagName = e), (this.attrs = n), (this.booleanAttrs = o), (this.unary = !1), (this.html5Unary = !1);
                                        }
                                        e.StartTagToken =
                                        ...
                                        function u(t, e, r, n, o, i) {
                                            s(this, u), (this.type = "startTag"), (this.length = e), (this.text = ""), (this.tagName = t), (this.attrs = r), (this.booleanAttrs = n), (this.html5Unary = !1), (this.unary = o), (this.rest = i);
                                        }
                                        e.AtomicTagToken =
                                        ...
                                        e.EndTagToken =
                                            ...
                                            p);
                                        function p(t, e) {
                                            s(this, p), (this.type = "endTag"), (this.length = e), (this.text = ""), (this.tagName = t);
                                        }
                                    },
                                    function (t, e) {
                                        "use strict";
                                            ...
                                            (e.default = function (r, n, e) {
                                                var o = (function () {
                                                    ...
                                                    i = {
                                                        startTag: function (t) {
                                                            var e = t.tagName;
                                                            "TR" === e.toUpperCase() && o.lastTagNameEq("TABLE")
                                                                ? (r.prepend("<TBODY>"), a())
                                                                : n.selfCloseFix && s.test(e) && o.containsTagName(e)
                                                                ? o.lastTagNameEq(e)
                                                                    ? u(r, o)
                                                                    : (r.prepend("</" + t.tagName + ">"), a())
                                                                : t.unary || o.push(t);
                                                        },
                                                        endTag: function (t) {
                                                            o.last() ? (n.tagSoupFix && !o.lastTagNameEq(t.tagName) ? u(r, o) : o.pop()) : n.tagSoupFix && (e(), a());
                                                        },
                                                    };
                                                function a() {
                                                    var t = (function (t, e) {
            ...
            (e.newEnvironment = function (r) {
                function e() {
                    return (
                        ...
                        !(function (t) {
                            try {
                                return t.top.location.toString(), !0;
                            } catch (t) {
                                return !1;
                            }
                        })(r)
                ...
                return {
                    isMobileApp: function (t) {
                        return t && "mobile-app" === t;
                    },
                    isCrossDomain: e,
                    isSafeFrame: function () {
                        return !(!r.$sf || !r.$sf.ext);
                    },
                    isAmp: function (t) {
